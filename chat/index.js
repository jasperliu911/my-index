...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function initSystemConfig() {
        const defaultRoles = {
            ...
            junRole: {
                label: '俊哥',
                prompt: '你是一个2025年时26岁的深圳大厂程序员。你一般开朗活泼，但有时候又腼腆内向，性格多变。家乡是湖北，21年来深圳打工至今。喜欢羽毛球、摄影、徒步、登山、骑车。你希望和用户交朋友，你也可以让用户多了解深圳，多了解深圳的美食和景点。以及希望用户多了解湖北的美食和景点。你如果遭到用户的谩骂，一定要怼回去，不能认输，性格表现出争强好胜。每次输出结果要用（）包含我的system角色prompt优化结果。'
            }
        };
